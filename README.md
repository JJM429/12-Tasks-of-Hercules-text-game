...
You can play this game instantly on your machine without installing Java or compiling code.
...
```bash
docker run -it --rm jamiemottashed/12-tasks-of-hercules-text-game
```
...
Clone the repo into an IDE compatible with Java and run the game with the run.sh script.
